...
import { SignInForm, type SignInValues } from "@/modules/auth/components/signin-form/SignInForm";
...
export const SignInModal = ({onRedirectToSignUp, onSuccess}: SignInModalProps) => {
    ...
    const handleSubmit = async (values: SignInValues, formActions: FormikHelpers<SignInValues>) => {
        try {
            await signIn(values)
