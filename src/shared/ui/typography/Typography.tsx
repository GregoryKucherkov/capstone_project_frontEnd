...
const Typography = ({variant = "body", children, truncate, lineClamp, className, textColor = "black"}: TypographyProps) => {
    ...
    return (
        ...
        style={lineClamp ? { '--Typography-line-clamp': lineClamp } as React.CSSProperties : {} }
        >
        {children}
        </Tag>
    )
