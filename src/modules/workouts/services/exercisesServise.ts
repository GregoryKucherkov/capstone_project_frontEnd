...
import type { CustomExercisesCreate, PaginatedExercises } from "@/shared/types/api"
...
export const exercisesService = {
  ...
  getListCustomExercises: async (skip: number, limit: number): Promise<PaginatedExercises> => {
