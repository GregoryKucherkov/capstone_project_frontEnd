  ...
  return (
    <Container className={css.container}>
      ...
      <Card>
        ...
        <Link className={css.linkTo} to="/add-workout/quick">
          START
        </Link>
      </Card>
      <Card>
        <Typography variant="h3">Start planned workout now</Typography>
        <Link className={css.linkTo} to="/add-workout/planned">
          Pick a day
        </Link>
      </Card>
      <Card>
        <Typography variant="h3">Manage your next workout!</Typography>
        <Link className={css.linkTo} to="/add-workout/manage">
          Create
        </Link>
      </Card>
      <Card>
        <Typography variant="h3">Favorite exercises</Typography>
        <Link className={css.linkTo} to="/add-workout/favorite">
          Check them
        </Link>
      </Card>
    </Container>
