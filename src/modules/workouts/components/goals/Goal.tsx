...
export const Goal = () => {
    ...
    return (
      <Container>
        <Card className={css.emptyGoal}>
          ...
          <Button variant="pink" size="small" className={css.emtyBtn}>
            Set a Goal
          </Button>
        </Card>
      </Container>
  ...
  const progress = Math.min(
    Math.round(
      (parseFloat(mainGoal.current_value) / parseFloat(mainGoal.target_value)) *
        100,
    ),
    100,
  );
    ...
    <section>
      <Container>
        <Card variant="thick" className={css.goalCard}>
          ...
          <div className={css.progressWrapper}>
            <div className={css.stats}>
              <Typography variant="body">
                Current: <strong>{mainGoal.current_value}kg</strong>
              </Typography>
              <Typography variant="body">
                Target: <strong>{mainGoal.target_value}kg</strong>
              </Typography>
            </div>
          ...
          <Button variant="light" size="small" className={css.emtyBtn}>
            Update Progress
          </Button>
        </Card>
      </Container>
